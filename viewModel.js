...
//    this.pokemonUI = pokemonUI;
  ...
  async startBattle(callback) {
    ...
    this.callBackFunction(`🏆 La batalla ha acabat! ${winner} és el guanyador!`,'h2');
  }
  ...
  fightRound() {
    return new Promise((resolve) => {
      ...
      this.callBackFunction("============================================");
      this.callBackFunction(`⚔️ ${pokemon1.name} vs ${pokemon2.name}`);
    ...
    `;*/
      ...
      setTimeout(() => {
        if (pokemon1.special_power == pokemon2.special_power) {
          this.callBackFunction(`💥 ${pokemon1.name} i ${pokemon2.name} es derroten mútuament!`,'p',true);
          ...
          this.callBackFunction(`💥 ${pokemon1.name} derrota ${pokemon2.name}!`);
          ...
          this.callBackFunction(`${message}`,'p',true);
        } else {
          this.callBackFunction(`💥 ${pokemon2.name} derrota ${pokemon1.name}!`);
